...
public class UnicodeUtil {
	...
	public static String unicode2tsc(String unicodeni){
		...
		unicodeni = unicodeni.replace("ஜ�?", "\\ˆ");
		unicodeni = unicodeni.replace("ஜ", "ƒ");
		...
		unicodeni = unicodeni.replace("க�?", "Ì");
		...
		unicodeni = unicodeni.replace("ங�?", "í");
		unicodeni = unicodeni.replace("ங", "¹");
		...
		unicodeni = unicodeni.replace("ஞ�?", "ï");
		unicodeni = unicodeni.replace("ஞ", "»");
		...
		unicodeni = unicodeni.replace("ட�?", "Î");
		...
		unicodeni = unicodeni.replace("ட�?", "ð");
		...
		unicodeni = unicodeni.replace("ண�?", "ñ");
		unicodeni = unicodeni.replace("ண", "½");
		...
		unicodeni = unicodeni.replace("த�?", "ò");
		unicodeni = unicodeni.replace("த", "¾");
		...
		unicodeni = unicodeni.replace("ந�?", "Ñ");
		...
		unicodeni = unicodeni.replace("ந�?", "ó");
		...
		unicodeni = unicodeni.replace("ன�?", "Û");
		...
		unicodeni = unicodeni.replace("ன�?", "ý");
		...
		unicodeni = unicodeni.replace("ப�?", "Ò");
		...
		unicodeni = unicodeni.replace("ப�?", "ô");
		unicodeni = unicodeni.replace("ப", "À");
	
	
		unicodeni = unicodeni.replace("மௌ", "¦�?ª");
		unicodeni = unicodeni.replace("மோ", "§�?¡");
		unicodeni = unicodeni.replace("மொ", "¦�?¡");
		unicodeni = unicodeni.replace("மா", "�?¡");
		unicodeni = unicodeni.replace("மி", "�?¢");
		unicodeni = unicodeni.replace("மீ", "�?£");
		unicodeni = unicodeni.replace("ம�?", "Ó");
		unicodeni = unicodeni.replace("மூ", "ã");
		unicodeni = unicodeni.replace("மெ", "¦�?");
		unicodeni = unicodeni.replace("மே", "§�?");
		unicodeni = unicodeni.replace("மை", "¨�?");
		unicodeni = unicodeni.replace("ம�?", "õ");
		unicodeni = unicodeni.replace("ம", "�?");
		...
		unicodeni = unicodeni.replace("ய�?", "Ô");
		...
		unicodeni = unicodeni.replace("ய�?", "ö");
		...
		unicodeni = unicodeni.replace("ர�?", "Õ");
		...
		unicodeni = unicodeni.replace("ல�?", "Ö");
		...
		unicodeni = unicodeni.replace("ல�?", "ø");
		...
		unicodeni = unicodeni.replace("ள�?", "Ù");
		...
		unicodeni = unicodeni.replace("ள�?", "û");
		...
		unicodeni = unicodeni.replace("வ�?", "ù");
		...
		unicodeni = unicodeni.replace("ழ�?", "Ø");
		...
		unicodeni = unicodeni.replace("ழ�?", "ú");
		...
		unicodeni = unicodeni.replace("ற�?", "Ú");
		...
		unicodeni = unicodeni.replace("ற�?", "ü");
		...
		unicodeni = unicodeni.replace("ஸ�?", "Š");
		unicodeni = unicodeni.replace("ஸ", "…");
		...
		unicodeni = unicodeni.replace("ஸ�?ரீ", "");
		unicodeni = unicodeni.replace("‘", "‘");
